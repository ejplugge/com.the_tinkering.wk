...
/**
 * View holder class for kanji subject items.
 */
public final class SubjectKanjiItemViewHolder extends SubjectItemViewHolder {
    /**
     ...
     */
    public SubjectKanjiItemViewHolder(final SearchResultAdapter adapter, final View view, final Actment actment) {
